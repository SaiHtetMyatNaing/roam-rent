...
const StatItem = ({ value, label, showStar = false }: StatItemProps) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-10">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/vehicles">
                <button
                  className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-7 py-3.5 rounded-lg font-semibold transition-all transform active:scale-95 shadow-md shadow-blue-200/30"
                  type="button"
                >
                  Browse Vehicles
                  <ArrowRight size={18} />
              ...
              <Link href="/register">
                <button
                  className="flex items-center justify-center border-2 border-blue-600 text-blue-600 hover:bg-blue-50 px-7 py-3.5 rounded-lg font-semibold transition-all transform active:scale-95"
                  type="button"
                >
                  Create Free Account
                </button>
